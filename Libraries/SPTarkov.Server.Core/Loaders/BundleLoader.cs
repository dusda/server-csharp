...
namespace SPTarkov.Server.Core.Loaders
{
  ...
  {
    readonly ISptLogger<BundleLoader> _logger;
    ...
    readonly InMemoryCacheService _inMemoryCacheService;
    readonly ICloner _cloner;
    readonly Dictionary<string, BundleInfo> _bundles = new Dictionary<string, BundleInfo>();
