...
public class EventOutputHolder
{
  ...
  void CleanUpCompleteCraftsInProfile(Dictionary<string, Production>? productions)
  {
  ...
  Dictionary<string, HideoutImprovement>? GetImprovementsFromProfileAndFlagComplete(PmcData pmcData)
  {
  ...
  Dictionary<string, Production>? GetProductionsFromProfileAndFlagComplete(Dictionary<string, Production>? productions, string sessionId)
  {
    foreach (var production in productions)
    {
  ...
  void ResetMoneyTransferLimit(MoneyTransferLimits limit)
  {
  ...
  Dictionary<string, TraderData> ConstructTraderRelations(Dictionary<string, TraderInfo> traderData)
  {
