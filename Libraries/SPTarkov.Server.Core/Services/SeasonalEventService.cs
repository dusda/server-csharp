...
)
{
  ...
  List<SeasonalEvent> _currentlyActiveEvents = [];
  bool _halloweenEventActive;
  ...
  bool DateIsBetweenTwoDates(DateTime dateToCheck, int startMonth, int startDay, int endMonth, int endDay)
  {
  ...
  void UpdateGlobalEvents(Config globalConfig, SeasonalEvent eventType)
  {
  ...
  void ApplyHalloweenEvent(SeasonalEvent eventType, Config globalConfig)
  {
  ...
  void ApplyChristmasEvent(SeasonalEvent eventType, Config globalConfig)
  {
  ...
  void ApplyNewYearsEvent(SeasonalEvent eventType, Config globalConfig)
  {
    _christmasEventActive = true;
  ...
  void AdjustBotAppearanceValues(SeasonalEventType season)
  {
  ...
  void ReplaceBotHostility(Dictionary<string, List<AdditionalHostilitySettings>> hostilitySettings)
  {
  ...
  void RemoveEntryRequirement(List<string> locationIds)
  {
