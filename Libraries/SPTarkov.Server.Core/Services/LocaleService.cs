...
)
{
  ...
  bool TryGetLocaleDbWithCustomLocales(string languageKey, out Dictionary<string, string>? localeToReturn)
  {
    localeToReturn = null;
  ...
  Dictionary<string, string> CombineDbWithCustomLocales(Dictionary<string, string> dbLocales, Dictionary<string, string> customLocales)
  {
  ...
  void AddToDictionary(string locale, string localeKey, string localeValue,
