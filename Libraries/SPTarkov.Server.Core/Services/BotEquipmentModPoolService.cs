...
public class BotEquipmentModPoolService
{
  ...
  bool SetContainsTpl(HashSet<string> itemSet, string tpl)
  {
    lock (_lockObject)
    {
  ...
  bool AddTplToSet(HashSet<string> itemSet, string itemToAddTpl)
  {
    lock (_lockObject)
    {
  ...
  bool InitSetInDict(ConcurrentDictionary<string, HashSet<string>> dictionary, string slotName)
  {
    lock (_lockObject)
    {
