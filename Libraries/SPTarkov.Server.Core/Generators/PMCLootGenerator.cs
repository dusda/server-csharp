...
{
  readonly ConfigServer _configServer;
  readonly DatabaseService _databaseService;
  readonly ItemFilterService _itemFilterService;
  readonly ItemHelper _itemHelper;
  readonly ISptLogger<PMCLootGenerator> _logger;
  readonly PmcConfig _pmcConfig;
  readonly RagfairPriceService _ragfairPriceService;
  readonly SeasonalEventService _seasonalEventService;
  readonly WeightedRandomHelper _weightedRandomHelper;

  ConcurrentDictionary<string, double>? _backpackLootPool;
  ConcurrentDictionary<string, double>? _pocketLootPool;
  ConcurrentDictionary<string, double>? _vestLootPool;
