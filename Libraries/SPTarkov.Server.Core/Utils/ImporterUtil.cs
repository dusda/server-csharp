...
public class ImporterUtil
{
  ...
  async Task ProcessDirectoryAsync(
      string directory,
      Type loadedType,
      object result,
      Lock dictionaryLock
  ...
  async Task<object> DeserializeFileAsync(FileStream fs, string file, Type propertyType)
  {
  ...
  object CreateLazyLoadDeserialization(string file, Type propertyType)
  {
