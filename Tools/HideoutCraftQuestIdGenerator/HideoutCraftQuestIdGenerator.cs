...
{
  static readonly HashSet<string> _blacklistedProductions =
  [
  ...
  static readonly Dictionary<string, string> _forcedQuestToProductionAssociations = new()
    {
        // KEY = PRODUCTION, VALUE = QUEST
        { "63a571802116d261d2336cd1", "625d6ffaf7308432be1d44c5" } // Network Provider - Part 2
    };

  readonly Dictionary<string, string> _questProductionMap = new();
  readonly List<QuestProductionOutput> _questProductionOutputList = [];
  ...
  bool IsValidQuestProduction(HideoutProduction production,
  ...
  HashSet<Reward> CombineRewards(QuestRewards? questRewards)
  {
