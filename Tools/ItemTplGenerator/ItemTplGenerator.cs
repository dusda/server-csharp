...
{
  readonly HashSet<string> collidedEnumKeys = [];
  string enumDir;
  IDictionary<string, string> itemOverrides;
  Dictionary<string, TemplateItem> items;
  ...
  Dictionary<string, string> GenerateItemsObject()
  {
  ...
  Dictionary<string, string> GenerateWeaponsObject()
  {
  ...
  string SanitizeEnumKey(string enumKey)
  {
    return enumKey
        .ToUpper()
  ...
  string GetParentName(TemplateItem item)
  {
  ...
  bool IsValidItem(TemplateItem item)
  {
  ...
  string GetItemPrefix(TemplateItem item)
  {
    var prefix = "";
  ...
  string GetItemSuffix(TemplateItem item)
  {
    var suffix = "";
  ...
  string GetAmmoPrefix(TemplateItem item)
  {
  ...
  string CleanCaliber(string ammoCaliber)
  {
  ...
  string GetAmmoBoxPrefix(TemplateItem item)
  {
  ...
  string GetMagazinePrefix(TemplateItem item)
  {
  ...
  string GetItemName(TemplateItem item)
  {
  ...
  string? GetItemNameSuffix(TemplateItem item)
  {
    var localeDb = _localeService.GetLocaleDb();
  ...
  void LogEnumValueChanges(Dictionary<string, string> data, string enumName, Type originalEnum)
  {
  ...
  void WriteEnumsToFile(string outputPath, Dictionary<string, Dictionary<string, string>> enumEntries)
  {
    var enumFileData =
